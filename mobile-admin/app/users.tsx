...
export default function UsersScreen() {
    ...
    return (
        <SafeAreaView className="flex-1" style={{ backgroundColor: theme.colors.background }}>
            <Stack.Screen options={{ title: 'Users', headerShown: true, headerStyle: { backgroundColor: theme.colors.background }, headerTintColor: theme.colors.text }} />
            <FlatList
                data={users}
                ...
                renderItem={({ item }: { item: any }) => (
                    <View
                        ...
                        <View className="items-end">
                            <Text className="text-[10px] font-medium px-1.5 py-0.5 rounded" style={{ backgroundColor: `${theme.colors.primary}15`, color: theme.colors.primary }}>
                                {item.role}
                            </Text>
                        </View>
                    </View>
