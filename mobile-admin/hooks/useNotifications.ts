...
function resolveDeviceId(): string {
    return Device.modelId || Device.modelName || Constants.installationId || 'unknown';
}
    ...
    useEffect(() => {
        ...
        async function setup() {
            try {
                ...
                console.error('[AdminNotifications] Setup failed:', error);
            }
        }
        ...
        const unsubscribeTokenRefresh = messaging().onTokenRefresh(async (newToken) => {
            ...
            try {
                ...
                console.error('[AdminNotifications] Failed to register refreshed token:', err);
            }
        });
