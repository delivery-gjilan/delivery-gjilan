...
ALTER TABLE "store_settings" ADD COLUMN "early_dispatch_lead_minutes" integer DEFAULT 5 NOT NULL;--> statement-breakpoint
ALTER TABLE "store_settings" ADD COLUMN "business_grace_period_minutes" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
...
CREATE INDEX "idx_promotion_audience_groups_active" ON "promotion_audience_groups" USING btree ("is_active");