...
export class DriverAuthService {
    ...
    private buildDriverResponse(user: { id: string; email: string; firstName: string; lastName: string; phoneNumber: string | null }, driver: { onlinePreference: boolean; connectionStatus: 'CONNECTED' | 'STALE' | 'LOST' | 'DISCONNECTED'; lastHeartbeatAt: string | null; lastLocationUpdate: string | null; driverLat: number | null; driverLng: number | null }) {
        return {
            id: user.id,
            email: user.email,
