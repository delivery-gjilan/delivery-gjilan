                ...
                {steps.map((step, index) => {
                    ...
                    return (
                        <View key={step.key} className="flex-1 items-center">
                            ...
                            <Text className={`text-xs mt-2 text-center ${isActive ? 'text-gray-700' : 'text-gray-400'}`}>
                                {step.label}
                            </Text>
        ...
        <ScrollView className="flex-1 bg-white">
            ...
            <View className="px-6 py-6">
                ...
                {currentStep === 'EMAIL_SENT' && (
                    <View>
                        <Text className="text-gray-600 mb-4">
                            We've sent a verification code to {user?.email}. Please check your email and enter the code
                            below.
                        </Text>
                        ...
                        <View className="mb-6">
                            ...
                            <TextInput
                                className="border border-gray-300 rounded-lg px-4 py-3 text-gray-900 text-center text-xl tracking-widest"
                                placeholder="000000"
                                value={emailCode}
                        ...
                        <TouchableOpacity className="py-3 mt-3">
                            <Text className="text-blue-600 text-center font-semibold">Didn't receive the code?</Text>
                        </TouchableOpacity>
                    </View>
                )}
                ...
                {currentStep === 'PHONE_SENT' && (
                    <View>
                        <Text className="text-gray-600 mb-4">
                            We've sent a verification code to {user?.phoneNumber}. Please check your messages and enter
                            the code below.
                        </Text>
