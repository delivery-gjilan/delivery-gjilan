...
export type FeaturedBusinessesHomeQuery = { __typename?: 'Query', featuredBusinesses: Array<{ __typename?: 'Business', id: string, name: string, imageUrl?: string | null, description?: string | null, isOpen: boolean, avgPrepTimeMinutes: number, prepTimeOverrideMinutes?: number | null, location: { __typename?: 'Location', latitude: number, longitude: number }, activePromotion?: { __typename?: 'BusinessPromotion', id: string, name: string, description?: string | null, type: PromotionType, discountValue?: number | null, spendThreshold?: number | null } | null }> };

export type GetBusinessesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetBusinessesQuery = { __typename?: 'Query', businesses: Array<{ __typename?: 'Business', id: string, name: string, description?: string | null, imageUrl?: string | null, businessType: BusinessType, isActive: boolean, avgPrepTimeMinutes: number, prepTimeOverrideMinutes?: number | null, isTemporarilyClosed: boolean, temporaryClosureReason?: string | null, isOpen: boolean, minOrderAmount: number, createdAt: any, updatedAt: any, location: { __typename?: 'Location', latitude: number, longitude: number, address: string }, workingHours: { __typename?: 'WorkingHours', opensAt: string, closesAt: string }, schedule: Array<{ __typename?: 'BusinessDayHours', id: string, dayOfWeek: number, opensAt: string, closesAt: string }>, activePromotion?: { __typename?: 'BusinessPromotion', id: string, name: string, description?: string | null, type: PromotionType, discountValue?: number | null, spendThreshold?: number | null } | null }> };
