...
export type CreateSettlementRuleMutation = { __typename?: 'Mutation', createSettlementRule: { __typename?: 'SettlementRule', id: string, name: string } };
