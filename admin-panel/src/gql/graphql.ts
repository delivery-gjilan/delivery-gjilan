...
export type ProductsAndCategoriesQuery = { __typename?: 'Query', productCategories: Array<{ __typename?: 'ProductCategory', id: string, name: string }>, products: Array<{ __typename?: 'ProductCard', id: string, name: string, imageUrl?: string | null, basePrice: number, isOffer: boolean, hasOptionGroups: boolean, variants: Array<{ __typename?: 'Product', id: string, businessId: string, categoryId: string, subcategoryId?: string | null, variantGroupId?: string | null, name: string, description?: string | null, imageUrl?: string | null, price: number, isOnSale: boolean, saleDiscountPercentage?: number | null, isAvailable: boolean, sortOrder: number, createdAt: string, updatedAt: string }>, product?: { __typename?: 'Product', id: string, businessId: string, categoryId: string, subcategoryId?: string | null, variantGroupId?: string | null, name: string, description?: string | null, imageUrl?: string | null, price: number, isOnSale: boolean, saleDiscountPercentage?: number | null, isAvailable: boolean, sortOrder: number, createdAt: string, updatedAt: string, variantGroup?: { __typename?: 'ProductVariantGroup', id: string, name: string } | null } | null }> };
