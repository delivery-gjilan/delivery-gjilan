...
export type SettlementsPageQuery = { __typename?: 'Query', settlements: Array<{ __typename?: 'Settlement', id: string, type: SettlementType, direction: SettlementDirection, isSettled: boolean, amount: number, currency: string, status: SettlementStatus, paymentMethod?: string | null, paymentReference?: string | null, paidAt?: any | null, ruleId?: string | null, createdAt: any, driver?: { __typename?: 'User', id: string, firstName: string, lastName: string, phoneNumber?: string | null } | null, business?: { __typename?: 'Business', id: string, name: string } | null, order?: { __typename?: 'Order', id: string, displayId: string, orderDate: any, status: OrderStatus, deliveryPrice: number, totalPrice: number, businesses: Array<{ __typename?: 'OrderBusiness', business: { __typename?: 'Business', id: string, name: string, businessType: BusinessType }, items: Array<{ __typename?: 'OrderItem', id: string, productId: string, name: string, quantity: number, unitPrice: number, notes?: string | null, selectedOptions: Array<{ __typename?: 'OrderItemOption', id: string, optionName: string, priceAtOrder: number }> }> }> } | null }> };
