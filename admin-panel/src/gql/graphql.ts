...
export type CreateSettlementRequestMutation = { __typename?: 'Mutation', createSettlementRequest: { __typename?: 'SettlementRequest', id: string, entityType: SettlementType, status: SettlementRequestStatus, amount: number, currency: string, periodStart: any, periodEnd: any, note?: string | null, expiresAt: any, createdAt: any } };
