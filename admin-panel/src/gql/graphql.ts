...
export type UpdateBusinessMutation = { __typename?: 'Mutation', updateBusiness: { __typename?: 'Business', id: string, name: string, phoneNumber?: string | null, businessType: BusinessType, imageUrl?: string | null, isActive: boolean, avgPrepTimeMinutes: number, prepTimeOverrideMinutes?: number | null, minOrderAmount: number, category?: string | null, location: { __typename?: 'Location', latitude: number, longitude: number, address: string } } };
...
export type BusinessQuery = { __typename?: 'Query', business?: { __typename?: 'Business', id: string, name: string, phoneNumber?: string | null, imageUrl?: string | null, businessType: BusinessType, isActive: boolean, avgPrepTimeMinutes: number, prepTimeOverrideMinutes?: number | null, createdAt: any, minOrderAmount: number, category?: string | null, location: { __typename?: 'Location', latitude: number, longitude: number, address: string }, workingHours: { __typename?: 'WorkingHours', opensAt: string, closesAt: string }, schedule: Array<{ __typename?: 'BusinessDayHours', id: string, dayOfWeek: number, opensAt: string, closesAt: string }> } | null };
...
export type DeductOrderStockMutation = { __typename?: 'Mutation', deductOrderStock: { __typename?: 'OrderCoverage', orderId: string, deducted: boolean, items: Array<{ __typename?: 'OrderCoverageItem', productId: string, productName: string, orderedQty: number, fromStock: number, fromMarket: number, status: InventoryCoverageStatus, deducted: boolean }> } };
...
export type OrderCoverageQuery = { __typename?: 'Query', orderCoverage?: { __typename?: 'OrderCoverage', orderId: string, totalItems: number, fullyOwnedCount: number, partiallyOwnedCount: number, marketOnlyCount: number, allFromStock: boolean, allFromMarket: boolean, deducted: boolean, items: Array<{ __typename?: 'OrderCoverageItem', productId: string, productName: string, productImageUrl?: string | null, orderedQty: number, fromStock: number, fromMarket: number, status: InventoryCoverageStatus, deducted: boolean }> } | null };
