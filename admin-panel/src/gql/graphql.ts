...
export type UpdateBusinessMutation = { __typename?: 'Mutation', updateBusiness: { __typename?: 'Business', id: string, name: string, phoneNumber?: string | null, businessType: BusinessType, imageUrl?: string | null, isActive: boolean, avgPrepTimeMinutes: number, prepTimeOverrideMinutes?: number | null, minOrderAmount: number, location: { __typename?: 'Location', latitude: number, longitude: number, address: string }, workingHours: { __typename?: 'WorkingHours', opensAt: string, closesAt: string }, schedule: Array<{ __typename?: 'BusinessDayHours', id: string, dayOfWeek: number, opensAt: string, closesAt: string }> } };
...
export type BusinessQuery = { __typename?: 'Query', business?: { __typename?: 'Business', id: string, name: string, phoneNumber?: string | null, imageUrl?: string | null, businessType: BusinessType, isActive: boolean, avgPrepTimeMinutes: number, prepTimeOverrideMinutes?: number | null, createdAt: any, minOrderAmount: number, location: { __typename?: 'Location', latitude: number, longitude: number, address: string }, workingHours: { __typename?: 'WorkingHours', opensAt: string, closesAt: string }, schedule: Array<{ __typename?: 'BusinessDayHours', id: string, dayOfWeek: number, opensAt: string, closesAt: string }> } | null };
...
export type SetInventoryQuantityMutation = { __typename?: 'Mutation', setInventoryQuantity: { __typename?: 'InventoryItem', id: string, productId: string, productName: string, productImageUrl?: string | null, productBasePrice: number, categoryName?: string | null, quantity: number, lowStockThreshold?: number | null, costPrice?: number | null, isLowStock: boolean, updatedAt?: any | null } };
...
export type BulkSetInventoryMutation = { __typename?: 'Mutation', bulkSetInventory: Array<{ __typename?: 'InventoryItem', id: string, productId: string, productName: string, quantity: number, costPrice?: number | null, isLowStock: boolean }> };
