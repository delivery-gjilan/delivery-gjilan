...
| BL8 | [BUSINESS_LOGIC/DRIVER_COMMISSION_MODEL_RECOMMENDATIONS.md](BUSINESS_LOGIC/DRIVER_COMMISSION_MODEL_RECOMMENDATIONS.md) | Business Logic | Commission architecture options: rule-only model, explicit hybrid pipeline, fallback guardrails, and recommended adoption path |
